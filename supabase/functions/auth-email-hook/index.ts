...
const SAMPLE_PROJECT_URL = "https://kidmapp.lovable.app"
...
const handler = createAuthEmailHandler({
  ...
  emails: {
    ...
    invite: {
      subject: 'Tu es invité(e) à rejoindre KidMapp',
      render: (data) =>
    ...
    magiclink: {
      subject: 'Ton lien de connexion KidMapp',
      render: (data) =>
