...
const ContributeMealsSheet = ({ locationId, open, onClose, onRequireAuth }: Props) => {
  const { user } = useAuth();
          ...
          >
            ...
            <div style={{ overflowY: 'auto', flex: 1, padding: '4px 20px 16px' }}>
              ...
              <div style={{ marginTop: 18 }}>
                ...
                <textarea
                  ...
                  placeholder="Ex : idéal pour le goûter, terrasse sympa..."
                  rows={3}
                  style={{
            ...
            >
              <button
                ...
                disabled={submitting || (user && selected.length === 0)}
...
export default ContributeMealsSheet;
